package com.huiiro.chatglm.sdk.utils;
...
public class TokenUtils {
     ...
     * 对 ApiKey 进行签名
     *
     * @param apiKey    登录创建 ApiKey <a href="https://open.bigmodel.cn/usercenter/apikeys">doc</a>
     * @param apiSecret apiKey的后半部分 axx.byy 取 byy 使用
     * @return Token
     */
